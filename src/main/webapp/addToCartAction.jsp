...
try{
	...
	ResultSet rs1=st.executeQuery("select * from cart where product_id='"+product_id+"' and email='"+email+"' and address is Null"); //already product in the cart table
	while(rs1.next()){		
	...
	if(z==0){ //product is not available in the cart table
		quantity = 1;
